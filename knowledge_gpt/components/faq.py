...
When you ask a question, MyDocGPT will search through the
document chunks and find the most relevant ones using the vector index.
Then, it will use GPT3 to generate a final answer.

## Is my data safe?
Yes, your data is safe. MyDocGPT does not store your documents or
...
No, the answers are not 100% accurate. MyDocGPT uses GPT-3 to generate
answers. GPT-3 is a powerful language model, but it sometimes makes mistakes 
and is prone to hallucinations. Also, MyDocGPT uses semantic search
...
But for most use cases, MyDocGPT is very accurate and can answer
